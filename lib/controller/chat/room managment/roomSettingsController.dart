...
class RoomSettingController extends GetxController {
  ...
  late String cameraRadio;
  late String privateMessageStatus;
  late String roomLock;
  late String roomType;
  late String speech;
  late String roomImageUrl;

  late String guestCallTime;
  late String memberTalkTime;
  late String adminTalkTime;
  late String superTalkTime;
  late String masterTalkTime;
  late String room_plan;
  late String roomLockResone;
  ...
  getData() async {
    ...
    if (response.statusCode == 200) {
      ...
      pickerColor = Color(
          int.parse(roomInfo["themeColor"].toString().substring(1), radix: 16) +
              0xFF000000); //////////////////
  ...
  void updatePickerColor(String color) {
    pickerColor =
        Color(int.parse(color.toString().substring(1), radix: 16) + 0xFF000000);
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  padding:
                      EdgeInsets.symmetric(horizontal: 60.w, vertical: 7.h),
                  decoration: BoxDecoration(
                    // color: Color(0xFFE60000),
                    color: Color(int.parse(
                            roomInfo["themeColor"].toString().substring(1),
                            radix: 16) +
                        0xFF000000),
  ...
  void changeExpansionTileStatus(int index) {
    dynamic value = setting[index]["isExpanded"];
    if (value is bool) {
      setting[index]["isExpanded"] = !value;
      update();
    }
  }
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) => GestureDetector(
                  ...
                  child: Container(
                    ...
                    color: Color(int.parse(
                            colorToPick[index].toString().substring(1),
                            radix: 16) +
                        0xFF000000),
                  ),
                ),
                  ...
                  .map(
                    (e) => RadioListTile(
                      ...
                      onChanged: (value) {
                        print(value);
                        cameraRadio =
                            value.toString(); // تحويل القيمة إلى String
                        update();
                      },
                    ),
                  )
                ...
                'لا أحد'
                  ...
                  .map(
                    (e) => RadioListTile(
                      ...
                      onChanged: (value) {
                        print(value);
                        privateMessageStatus = value.toString();
                        update();
                      },
                    ),
                  )
          ...
          builder: (controller) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                //                 value.toString(); // تحويل القيمة إلى String
                //             if (index == 0) {
                //               controller.changeSendImage(stringValue);
                //             } else if (index == 1) {
                //               controller.changeSendText(stringValue);
                //             } else if (index == 2) {
                //               controller.changeSendVoiceInPrivate(stringValue);
                //             } else if (index == 3) {
                //               controller.changeSendAlerts(stringValue);
                //             } else {
                //               controller.changeRoomEntries(stringValue);
                //             }
                //             update();
                //           },
                //         ),
                ...
                //     color: Colors.black,
                //     size: 30.sp,
                //   ), leading: null, backgroundColor: null, subtitle: null, onExpansionChanged: (bool value) {  }, tilePadding: null,
