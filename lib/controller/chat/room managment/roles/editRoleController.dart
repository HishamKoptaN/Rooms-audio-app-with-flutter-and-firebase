...
class EditRolesController extends GetxController {
  ...
  void onInit() {
    ...
    [
      ...
      "adminMangment",
        ...
        .mapIndexed((e, i) => icons[i]["isActive"] =
            Get.arguments["data"][e] == "1" ? true : false)
        .toList();
    update();
  ...
  void changeSeletedIndex(int newIndex) {
    selectedIndex = newIndex; // تحويل نوع القيمة إلى num
  ...
  void changeIconColor(int index) {
    if (icons[index]["isActive"] is bool) {
