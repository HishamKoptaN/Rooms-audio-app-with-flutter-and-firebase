  ...
  loginRoleAccount(
    ...
    if (roleUsernameController.text.trim().isEmpty ||
      ...
      if (databody["status"] == "success") {
        ...
        accountMangment =
            databody["data"]["accountMangment"] == "1" ? true : false;
        ...
        memberMangment =
            databody["data"]["memberMangment"] == "1" ? true : false;
        masterMangment =
            databody["data"]["masterMangment"] == "1" ? true : false;
        superAdminMangment =
            databody["data"]["superAdminMangment"] == "1" ? true : false;
...
Future<String> getId() async {
  ...
  if (Platform.isIOS) {
    ...
    return iosDeviceInfo.identifierForVendor ?? ''; // Use empty string if null
  } else if (Platform.isAndroid) {
    var androidDeviceInfo = await deviceInfo.androidInfo;
    return androidDeviceInfo.id ?? ''; // Use empty string if null
  }

  // Default case, return an empty string or throw an error based on your logic.
  return '';
}
