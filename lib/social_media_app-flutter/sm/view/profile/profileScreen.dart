...
import '../../view/commonWidgets/followButton.dart';
import '../../view/commonWidgets/postWidget.dart';
import '../../view/profile/editProfileScreen.dart';
import '../../view/profile/followersFollowingsScreen.dart';
import 'package:easy_localization/easy_localization.dart';
import '../../view/profile/setting/languageScreen.dart';
import '../../view/profile/setting/savedPostScreens.dart';
import '../../view/profile/setting/themeScreen.dart';
import '../../view/post/viewPostScreen.dart';
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(
                        child: Icon(
                            viewImages ? IconlyBold.image : IconlyLight.image)),
                    decoration: BoxDecoration(
                      border: Border(
                          bottom: BorderSide(
          ...
          viewImages == false
              ...
              //user's posts
              ref
                  .watch(getUserPostsByUidControllerProvider(widget.userId))
                  .when(
                  data: (data) {
              ...
              ref
                  ...
                  data: (data) {
                    var imageDatas =
                        data.where((post) => post.postImage != null).toList();
                        ...
                        return GestureDetector(
                          onTap: () {
                            ...
                            navigatorPush(
                                context,
                                ViewPostScreen(
                                    postId: imageDatas[index].postId));
                          },
                          child: ClipRRect(
                              borderRadius: BorderRadius.circular(5),
                              child: Image.network(imageDatas[index].postImage!,
                                  fit: BoxFit.cover)),
                        );
                      },
                    );
    ...
    child: Row(
      ...
      children: [
            ...
            onTap: () {
              navigatorPush(
                  ...
                  FollowersFollowingsScreen(
                      username: user.name, userId: user.uid));
            },
            child: _buildStatItem(
                '${tr(LocaleKeys.lblFollowers)}', user.followers.length)),
        ...
        GestureDetector(
            ...
            child: _buildStatItem(
                '${tr(LocaleKeys.lblFollowing)}', user.followings.length)),
      ],
    ),
  );
}
