...
import '../../view/commonWidgets/circleCameraButton.dart';
...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  editPost({required String uid}) async {
    bool status = await ref.read(userControllerProvider.notifier).editUser(
        uid: uid,
      ...
      return Scaffold(
        appBar: AppBar(
          ...
          bottom: PreferredSize(
              ...
              child: ref.watch(userControllerProvider)
