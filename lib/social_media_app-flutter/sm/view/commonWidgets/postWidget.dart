...
import '../../view/commonWidgets/myTextWidget.dart';
import '../../view/commonWidgets/shimmerWidget.dart';
import '../../view/home/postImageView.dart';
import '../../view/post/editPostScreen.dart';
import '../../view/profile/profileScreen.dart';
import '../../view/home/commentScreen.dart';
import '../../view/home/peopleWhoReactedScreen.dart';
...
class _PostWidgetState extends ConsumerState<PostWidget> {
  ...
  goToCommentScreen(PostModel post) {
    navigatorPush(context,
        CommentScreen(postId: post.postId, postSharerUserId: post.userId));
  }
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            MyTextWidget(
                              text:
                                  "${post.username}".capitalizeFirst.toString(),
                            ),
                    ...
                    ListTile(
                      onTap: () {
                        ...
                        navigatorPushReplacement(
                            context, EditPostScreen(post: post));
                      },
                  ...
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        ...
                        title: ref
                            .watch(getUserByIdController(currentUserId))
                            .when(
                                data: (data) {
