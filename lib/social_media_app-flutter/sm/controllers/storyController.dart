...
import '../repositories/storyRepository.dart';
...
final getUserStoriesControllerProvider =
...
final getUsersWhoSharedStoriesControllerProvider =
    FutureProvider.family((ref, List<String> userIds) {
  return ref
      .watch(storyControllerProvider.notifier)
      .getUsersWhoSharedStories(userIds);
});
