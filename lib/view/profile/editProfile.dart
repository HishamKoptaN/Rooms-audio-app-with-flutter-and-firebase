...
class EditProfileAccount extends StatelessWidget {
          ...
          return controller.isLoading
              ...
              : ListView(
                  ...
                  children: [
                                  ...
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    onChanged: (String? newValue) {
                                      controller.changeDropdownValue(newValue ??
                                          ""); // يمكنك توفير قيمة افتراضية هنا إذا كنت متأكدًا من أنها لن تكون null
                                    },
                                  ),
                                );
                              },
                    ...
                    formBuilder("حالة الدردشة", controller.chatStatusController,
                        icon: Image.network(
                          'assets/icons/profile/gender.png',
                          width: 18.w,
                        ),
  ...
  Widget formBuilder(String title, TextEditingController controller,
      {required Widget icon, bool isIcon = false}) {
    return Padding(
      padding: EdgeInsets.only(bottom: 10.h),
      child: Directionality(
        textDirection: TextDirection.rtl,
