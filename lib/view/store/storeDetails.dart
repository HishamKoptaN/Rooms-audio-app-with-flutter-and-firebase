...
import '../../controller/store/storeDetailsController.dart';
...
class StoreDetails extends StatelessWidget {
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        roomTabBuilder(
                                            title: "العروض", index: 3),
                                        roomTabBuilder(
                                            title: "غرف فضية", index: 2),
                                        roomTabBuilder(
                                            title: "غرف دهبية", index: 1),
                                        roomTabBuilder(
                                            title: "غرف مميزة", index: 0),
                                      ],
                                    ),
                                    SizedBox(
                                      height: 460.h,
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        namesTabBuilder(
                                            title: "محمي عادي", index: 4),
                                        namesTabBuilder(
                                            title: "vip محمي مميز", index: 3),
                                        namesTabBuilder(
                                            title: "ملكي عادي", index: 2),
                                        namesTabBuilder(
                                            title: "vip ملكي مميز", index: 1),
                                        namesTabBuilder(
                                            title: "Top Won", index: 0),
                                      ],
                                    ),
                                    SizedBox(
                                      height: 495.h,
  ...
  Widget framesBuilder(
      {String? title, String? imageUrl, String? price, bool isFrame = true}) {
    return GetBuilder<StoreDetailsController>(builder: (c) {
      return GestureDetector(
        ...
        onTap: () {
          ...
          print("object");
          !isFrame
              ? c.updateSelectedEntryImage(imageUrl!, price!)
              : c.updateSelectedFrameImage(imageUrl!, price!);
              ...
              children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            width: Get.width * .40,
                            child: Column(
                              mainAxisAlignment: index! < 3 && !isRoot
                              ...
                              : index == 0
                                  ...
                                  : index == 1
                                      ? Image.asset('assets/images/vip.png',
                                          height: 45.sp, fit: BoxFit.fitHeight)
                                      : index == 2
                                          ? Image.asset(
                ...
                isDialog
                    ...
                    : GestureDetector(
                        ...
                        //                 mainAxisAlignment: MainAxisAlignment.center,
                        //                 children: [
                        //                   Image.network('assets/icons/store/dollar.png'),
                        //                   SizedBox(width: 3.w),
                        //                   Text(
                        //                     "320",
                        //                     textAlign: TextAlign.center,
      ...
      builder: (context) => SizedBox(
        ...
        child: Column(
          children: [
            Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: (Get.width * .10).w, vertical: 20.h),
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  Get.back();
                  isFrame
                      ? buyFrame(isForMe: false)
                      : buyEntries(isForMe: false);
                },
                child: Container(
                  decoration: BoxDecoration(
                    color: Colors.white,
        ...
        builder: (c) {
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: title == "Vip" ? 10.h : 8.w,
                    vertical: title == "Vip" ? 9.h : 5.h),
                child: Text(
                  title!,
                  style: TextStyle(
                    color: Colors.black,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: index == 0 || index == 1
              ? DecorationImage(
                  image: NetworkImage(baseURL + "test/1.png"),
                  fit: BoxFit.cover)
              : null,
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: [
            // Image.network('assets/images/vip.png', height: 33.sp, fit: BoxFit.fitHeight),
            Padding(
              padding:
                  EdgeInsets.only(bottom: index == 2 || index == 1 ? 30.h : 0),
              child: index == 0
                  ...
                  : index == 1
                      ...
                      : index == 2
                          ? Image.asset('assets/images/vipBadge.png',
                              height: 50.sp, fit: BoxFit.fitHeight)
                          : const Icon(
                              Icons.verified,
                              color: Colors.blue,
