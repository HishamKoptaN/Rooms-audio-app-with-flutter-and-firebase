...
import '../../controller/controller Panel/controllerPanelController.dart';
import '../../controller/userData/userCredentials.dart';
import '../../controller/userData/variables.dart';
import '../chat/In Room Widgets/appBar.dart';
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            colors: controller.selectedPage == index
                                ? [Color(0xFFF792F0), Color(0xFFFABD63)]
                                : [Colors.white, Colors.white],
                            begin: Alignment.topCenter,
                            end: Alignment.bottomCenter,
                          ),
                          borderRadius: BorderRadius.circular(10.r),
                          border: controller.selectedPage == index
                              ? null
                              : Border.all(color: Color(0xFFFABD63)),
                        ),
                        child: Center(
                          child: Text(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) => Padding(
                      ...
                      child: PopupMenuButton(
                        itemBuilder: (context) => [
                          statusBuilder("تعديل", icon: Icon(Icons.edit),
                              onTap: () {
        ...
        Container(
          decoration: BoxDecoration(
            image: DecorationImage(
                image: NetworkImage(controlPanelBanner), fit: BoxFit.cover),
          ),
          width: 381.w,
          height: 216.h,
        ),
