      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: Color(int.parse(
                                        controller.themeColor.substring(1, 7),
                                        radix: 16) +
                                    0xFF000000)
                                .withOpacity(0.2)),
                        child: StreamBuilder(
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    userInCall(
                                        userName: snapshot.data[3]['name']),
                                    userInCall(
                                        userName: snapshot.data[4]['name']),
                                  ],
                                );
                              }

                              // إذا وصلت إلى هذا المكان، يمكنك إضافة return إضافي إذا كان مناسباً
                              return SizedBox
                                  .shrink(); // أو أي عنصر آخر ترغب في إعادته
                            }
            ...
            GetBuilder<RoomsPageController>(
              init: RoomsPageController(),
              builder: (controller) => userName == controller
                  // .roomOwner
                  ? Container(
                      width: Get.width,
                                ...
                                return snapshot.hasData
                                    ? NotificationListener(
                                        onNotification:
                                          ...
                                          // إلقاء استثناء في حالة عدم وجود قيمة للإرجاع
                                          throw StateError(
                            ...
                            child: data["image"] == "1"
                                ...
                                : Text(
                                    ...
                                    textAlign: data["senderName"] == userName
                                        ...
                                        : TextAlign.left,
                                    style: TextStyle(
                                      fontSize: data["message"]
                                              .toString()
                                              .contains(
                                                  "لقد تم حذف هذه الرسالة")
                                          ? 18.sp
                                          : int.parse(data["fontSize"]).sp,
