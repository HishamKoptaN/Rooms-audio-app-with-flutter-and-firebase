...
import '../../../controller/chat/room managment/advancedSettingsController.dart';
import '../../../controller/chat/roomPageSettingsController.dart';
...
class AdvancedSettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          appbarBuilder("إعدادات متقدمة", true, color: Get.arguments["color"]),
      body: Padding(
...
Widget showAlert(BuildContext context) {
  ...
  // يتم إضافة عبارة return هنا
  return Container(); // أو أي عنصر واجهة مستخدم آخر تفضله
}
