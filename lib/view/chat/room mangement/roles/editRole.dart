...
// import '../controller/chat/room%20managment/roles/EditRolesController.dart';
import '../../../../controller/chat/room managment/roles/editRoleController.dart';
            ...
            return Directionality(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) =>
                    accessBuilder(index, controller),
              ),
            );
          }),
          SizedBox(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: controller.icons[index]["isActive"] != null
                    ? Color(int.parse(color.substring(1, 7), radix: 16) +
                        0xFF000000)
                    : Color(0xffE7E7E7),
            ...
            Text(
              controller.icons[index]["text"].toString(),
              style: TextStyle(
                fontWeight: FontWeight.bold,
                color: Colors.black,
                fontSize: 10.sp,
