...
import '../../../../controller/chat/blockController.dart';
                      ...
                      children: [
                        ...
                        OutlinedButton(
                          style: OutlinedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                                borderRadius:
                                    BorderRadius.circular(20.r)), // Text color
                            // backgroundColor: ``,
                            side: BorderSide.none, // Border color
                          ),
                          onPressed: () {
              ...
              child: GetBuilder<BlockController>(builder: (controller) {
                return PageView(
                  ...
                  children: [
                    ...
                    //         onTap: () {
                    //           // // Get.back();
                    //           // controller.removeBan(snapshot.data[index]
                    //           //         ["username"]!
                    //           //     .toString());
                    //         },
                    //         child: Align(
                    ...
                    //                   ),
                    //                   Text(
                    //                     snapshot.data[index]["macAddress"]
                    //                         .toString(),
                    //                     style: TextStyle(
                    //                       color: Colors.black,
                    //                       fontSize: 16.sp,
                    ...
                    Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          //           GestureDetector(
                          //             onTap: () {
                          //               controller.deleteBannedCountry(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              width:
                                  50.sp, // Set the width and height as needed
                              height: 50.sp,
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                color: Color(int.parse(color.substring(1, 7),
                                        radix: 16) +
                                    0xFF000000), // Set the background color as desired
                              ),
                              child: Center(
                                child: Icon(
                                  Icons.add,
