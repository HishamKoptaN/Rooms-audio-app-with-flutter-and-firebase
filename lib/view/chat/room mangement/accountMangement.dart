...
import '../../../controller/chat/room managment/accountMangementController.dart';
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: //controller.selectedIndex == index
                                ...
                                color: controller.index == 0
                                    ? Color(int.parse(color.substring(1, 7),
                                            radix: 16) +
                                        0xFF000000)
                                    : Colors.white,
                              ...
                              showMenu(
                                  ...
                                  items: [
                                    PopupMenuItem<int>(
                                      ...
                                      onTap: () => controller
                                          .changeSelectedMasterType("ماستر"),
                                      child: Center(
                                        child: Text(
                                          "Master (Man)",
                                          style: TextStyle(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (controller.index == 0) {
                            ...
                            return (controller.index - 1).toString() !=
