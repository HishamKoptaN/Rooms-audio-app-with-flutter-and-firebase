...
class RoomMangement extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:
          appbarBuilder("إدارة الغرفة", true, color: Get.arguments["color"]),
      body: Padding(
                            ...
                            children: [
                              ...
                              Text(
                                (table1[index]["name"] as String?) ??
                                    "", // استخدام as للتحويل و ?? للتحقق من القيمة المسترجعة
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 16.sp,
                                  fontWeight: FontWeight.bold,
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                table2[index]["name"]?.toString() ??
                                    "", // إضافة ? و toString() للتعامل مع قيمة محتملة للفارغة
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 16.sp,
                                  fontWeight: FontWeight.bold,
