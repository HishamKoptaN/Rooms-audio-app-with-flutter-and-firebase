...
import '../../controller/chat/roomInfoController.dart';
...
class RoomInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          appbarBuilder("معلومات الغرفة", true, color: Get.arguments["color"]),
      body: SafeArea(
            ...
            return FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                return ListView(
                  ...
                  //         return infoSetting(
                  //           titles[index].values.first,
                  //           snapshot.data!["data"][0][titles[index].values.last]
                  //               .toString(),
                  //         );
                  //       },
                  //     ),
  ...
  Widget otherInfoSetting(String title, String subtitle,
      {Color color1 = Colors.black,
      Color color2 = Colors.black,
      int fontsize1 = 13,
      int fontsize2 = 15,
